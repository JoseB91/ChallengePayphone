...
struct CreateUserView: View {
    ...
    var body: some View {
        if #available(iOS 16.0, *) {
            ...
            NavigationView {
                form
                    .alert(isPresented: $showLocationPopup) {
                        let message: String = {
                        ...
                        return Alert(
                            title: Text(String(localized: "LOCATION_TITLE")),
                    ...
                    .alert(isPresented: Binding(
                        ...
                        Alert(
                            title: Text(String(localized: "LOCATION_ERROR_TITLE")),
                            message: Text(locationManager.locationError?.localizedDescription ?? ""),
                            dismissButton: .default(Text(String(localized: "OK")))
                        )
                    }
            }
